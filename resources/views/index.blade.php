                ...
                <div class="top w-100 p-2 row align-items-center p-2 pt-4 pb-4" style="height: 15%;">
                   ...
                   <form>
                    ...
                    <div class="col-5 d-flex gx-1 justify-content-end  ">
                        ...
                        <form action="{{route('etu.deleteall')}}" method=" get">
                    ...
                    <table class="table table-hover students"  >
                        ...
                        <thead>
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="{{route('etu.delete',$post->id)}}" >       
                ...
                <div class=" w-100   border  background position-relative" style="min-height: 75vh; border-radius: 20px;"> 
                  ...
                  <div class="modify-student-form d-none p-4">
                    ...
                    <div class=" mt-4 d- flex align-items-center">
                        <div class="mb-1 btn btn-outline-primary" style="border-radius: 20px; padding-bottom: 4px; padding-top: 4px;" disabled >Math 1as
                            <a href="./index.html">
    ...
    <div class="front d-flex justify-content-center w-100 h-100  row d-none m-0 " style=" z-index: 10; position: absolute; top: 0; ">
        ...
        <div class="conatiner h-100 row position-absolute top-0 left-0 justify-content-center align-items-center " >
          ...
          <div class="p-4">
              ...
              <div class=" mt-4 d- flex align-items-center">
                  <button type="button " class="mb-1 btn btn-outline-primary" style="border-radius: 20px; padding-bottom: 4px; padding-top: 4px;"  >Math 2as
                      
                      <svg xmlns="http://www.w3.org/2000/svg"  width="16" height="16" fill="currentColor"  class="bi bi-x" viewBox="0 0 16 16">
                          <path  d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                        </svg>
                  </button>
                  <button type="button " class="mb-1 btn btn-outline-primary " style="background-color: rgba(255, 255, 255, 0.799); border-radius: 20px; padding-bottom: 4px; padding-top: 4px;"  >Education financiere
